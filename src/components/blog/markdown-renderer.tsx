...
const components = {
    h1: (props: any) => (
        <h1 className="mt-8 scroll-m-20 text-4xl font-extrabold tracking-tight lg:text-5xl" {...props} />
    ),
    h2: (props: any) => (
    ...
    pre: (props: any) => (
        <pre className="mb-4 mt-6 overflow-x-auto rounded-lg border bg-black py-4 dark:bg-zinc-900" {...props} />
    ),
    code: (props: any) => (
